            ...
            <div class="flex items-start">
              ...
              <div className="play cursor-pointer">
                <div className="w-[154px] h-[154px] rounded-full bg-[#fff]/[0.3] hover:bg-[#ccc]/[1] transition-all duration-400 ease-linear relative">
                  <div className="play absolute w-[50px] h-[50px] border-[25px] border-x-0 border-transparent border-l-white border-l-[50px] top-1/2 -translate-y-1/2 left-1/2 -translate-x-[32%] hover:rotate-360 transition-all duration-500"></div>
                </div>
              </div>
            </div>
          </div>
