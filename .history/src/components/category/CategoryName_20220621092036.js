...
const CategoryName = ({ name = "" }) => {
  return (
    <CategoryNameStyles>
      ...
      />
      <div className="absolute bottom-0 right-0 flex items-center max-w-[247px] w-full justify-between p-3 bg-white cursor-pointer">
        <p className="text-base">{name}</p>
        <div className="icon w-[39px] h-[18px] text-3xl">
          <svg
