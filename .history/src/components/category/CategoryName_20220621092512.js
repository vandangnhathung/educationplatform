...
const CategoryName = ({ name = "" }) => {
  return (
    <CategoryNameStyles>
      ...
      />
      <div className="absolute bottom-0 right-0 flex items-center max-w-[247px] w-full justify-between p-3 bg-white cursor-pointer box-border">
        ...
        <div className="icon">
          <svg
            ...
            viewBox="0 0 24 24"
            stroke="currentColor"
            className="box-border w-16 h-full max-h-9 a"
          >
            <path
