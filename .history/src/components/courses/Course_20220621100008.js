...
const CourseStyles = styled.div`
  height: 570px;
  box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 10px 3px;
`;
const Course = () => {
  return (
    <CourseStyles>
      ...
      <div className="flex items-center justify-between px-8 py-5 content-course">
        ...
        <div className="content-course__left">
          <button className="px-7 py-3 bg-[#1D8C74] text-white text-base flex items-center justify-between">
            <p>Email</p>
            <div className="">
              <svg
