    ...
    <CourseStyles>
      ...
      <div className="flex items-center justify-between px-8 py-3 content-course">
        ...
        <div className="content-course__left">
          <button className="px-8 py-3 bg-[#1D8C74] text-white text-base flex items-center justify-between hover:bg-[#D6F4EE] transition-all duration-300 hover:text-[#1D8C74] hover:font-medium">
            <p>Email</p>
            <div className="">
              <svg
