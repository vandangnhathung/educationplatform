...
function SampleNextArrow(props) {
  ...
  return (
    <button
      className="slide-right bg-[#1D8C74] border border-[#1D8C74] p-3 "
      onClick={onClick}
    >
      <svg
        width="16"
...
function SamplePrevArrow(props) {
  ...
  return (
    <button
      className="p-3 slide-left bg-white border  border-[#1D8C74]"
      onClick={onClick}
    >
      <svg
        width="16"
      ...
      <div className="flex items-center justify-between content">
        <div className="flex flex-col items-start gap-12 evaluate">
          <div className="evaluate-content">
            <Slider className="max-w-[500px] w-full" {...settings}>
