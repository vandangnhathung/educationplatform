...
function SampleNextArrow(props) {
  ...
  return (
    <button
      className="slide-right absolute bottom-[-205] bg-[#1D8C74] border border-[#1D8C74] p-3 "
      onClick={onClick}
    >
      <svg
        width="16"
...
function SamplePrevArrow(props) {
  ...
  return (
    <button
      className="p-3 slide-left absolute bottom-[-205] bg-white border  border-[#1D8C74]"
      onClick={onClick}
    >
      <svg
        width="16"
