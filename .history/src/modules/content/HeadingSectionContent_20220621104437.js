...
const HeadingSectionContent = ({ type = "" }) => {
  return (
    {type === "two" ? <div className="flex items-center justify-between max-w-[970px]">
  ...
  </div> : <div className="flex items-center justify-between max-w-[970px]">
      <h2 className="text-5xl font-medium max-w-[468px]">
        Explore courses by category
      </h2>
      <p className="text-base font-light max-w-[470px]">
